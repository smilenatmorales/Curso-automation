...
@DefaultUrl("https://colorlib.com/polygon/metis/login.html") // con la url de prueba, la cual será utilizada por el
																// método .open, que agregamos en los steps.
...
public class ColorlibLoginPage extends PageObject {
	...
	public void IngresarDatos(String strUsuario, String strPass) {// Recibe los parametros de usuario y clave desde los
																	// steps
